...
echo -e "${GREEN}[1]${RESET} Install everything"
echo -e "${CYAN}[2]${RESET} Install Fastfetch"
echo -e "${YELLOW}[3]${RESET} Install Fish"
echo -e "${MAGENTA}[4]${RESET} Install Kitty"
...
1)
    echo -e "${CYAN}Installing everything...${RESET}"

    cp -r fastfetch ~/.config/
    echo -e "${GREEN}✓ Fastfetch installed${RESET}"

    cp -r fish ~/.config/
    echo -e "${GREEN}✓ Fish installed${RESET}"

    cp -r kitty ~/.config/
    echo -e "${GREEN}✓ Kitty installed${RESET}"

    cp -r tofi ~/.config/
    echo -e "${GREEN}✓ Tofi installed${RESET}"

    cp -r dernoxium ~/.local/share/plasma/look-and-feel/
    echo -e "${GREEN}✓ Dernoxium KDE theme installed${RESET}"
